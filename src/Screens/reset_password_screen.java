...
public class reset_password_screen extends JFrame implements ActionListener, KeyListener{
    //    JLabel label;
//    JButton b1;
//    JLabel l1;
//    JPanel panel1;
    ...
    public reset_password_screen (BufferedImage bg_img) throws IOException {
        ...
        JButton sign_in_button = new JButton("Reset");
...
//        create_account_label.setOpaque(true);
        ...
        JLabel forgot_password_label = new JLabel("Sign up");
...
//                System.out.println(password_field_value);
                ...
                try {
                    //&& !isEmpty &&isEmail
                    //haruchhi@gmail.com
                    if(account_manager.userExistsReset(email_field_value) && !isEmpty &&isEmail){
                        ...
                        setVisible(false);
                        try {
                            new password_reset_confirmation_screen(bg_img, user, verification_code);
                            dispose();
                        } catch (IOException ex) {
                            throw new RuntimeException(ex);
                        }
