...
//    JPanel panel1;
    ...
    public password_reset_confirmation_screen (BufferedImage bg_img, Account user, int verification_code) throws IOException {
        ...
        email_label.setBounds(30, 25, 400,100);
        ...
        email_field.setBounds(30,email_label.getY()+130,p2.getWidth()-60,45);
        ...
        sign_in_button.setFont(new Font("Serif", Font.PLAIN, 20));
        //sign_in_button.setBorder(new LineBorder(Color.black, 2));
        sign_in_button.setBounds(60, 230, p2.getWidth()-120, 45);
